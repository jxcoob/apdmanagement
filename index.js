...
client.on('interactionCreate', async interaction=>{
  ...
  try{
    if(cmd==='infraction'){
      ...
      // Reply to the interaction FIRST to acknowledge it
      ...
      // Use editReply instead of reply since we already replied
